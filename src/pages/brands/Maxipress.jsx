...
const Maxipress = () => {
  const categories = ["High-Pressure Garment Finishing", "Steam Ironing Tables", "Utility Presses", "Form Finishers"];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="relative text-center mb-24 py-10 w-full flex flex-col items-center justify-center">
          <div className="relative inline-block mt-8 md:mt-0">
             ...
             <h1 className="text-7xl md:text-8xl font-serif text-[#0F172A] tracking-[0.1em] uppercase">MAXIPRESS</h1>
          </div>
        </motion.div>
            ...
            <table className="w-full text-left font-sans text-slate-500 font-light">
              ...
              <tbody className="divide-y divide-[#0B3C5D]/5 text-lg">
                <tr className="hover:bg-[#0B3C5D]/5 transition-colors">
                  <td className="p-6 font-medium text-[#0F172A]">MP Utility Press</td>
                  <td className="p-6">High Output</td>
                  <td className="p-6">Pneumatic Actuation</td>
                  <td className="p-6">Polished Head Pressure</td>
                </tr>
                <tr className="hover:bg-[#0B3C5D]/5 transition-colors">
                  <td className="p-6 font-medium text-[#0F172A]">MF Form Finisher</td>
                  <td className="p-6">Multi-Garment</td>
                  <td className="p-6">Timer Controlled</td>
                  <td className="p-6">Updraft Steam Flow</td>
                </tr>
              </tbody>
            </table>
          </div>
