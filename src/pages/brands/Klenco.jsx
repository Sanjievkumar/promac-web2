...
const Klenco = () => {
  const categories = ["Specialized Detergents", "Emulsifiers", "Fabric Softeners", "Hygiene Boosters"];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="relative text-center mb-24 py-10 w-full flex flex-col items-center justify-center">
          <div className="relative inline-block mt-8 md:mt-0">
             ...
             <h1 className="text-7xl md:text-8xl font-serif text-[#0F172A] tracking-[0.1em] uppercase">KLENCO</h1>
          </div>
        </motion.div>

        {/* CATEGORIES */}
        <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-24">
          <h2 className="text-4xl font-serif text-[#0F172A] mb-12 border-b border-[#0B3C5D]/10 pb-4">Chemical Solutions</h2>
          ...
          <div className="bg-white/80 backdrop-blur-xl border border-white/60 rounded-[30px] premium-shadow overflow-hidden">
            <table className="w-full text-left font-sans text-slate-500 font-light">
              <thead className="bg-[#0B3C5D]/5 text-[#0F172A] font-medium text-sm uppercase tracking-widest border-b border-[#0B3C5D]/10">
                <tr>
                  <th className="p-6">Product Line</th>
                  <th className="p-6">Packaging</th>
                  <th className="p-6">Application</th>
                  <th className="p-6">Key Benefit</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[#0B3C5D]/5 text-lg">
                <tr className="hover:bg-[#0B3C5D]/5 transition-colors">
                  <td className="p-6 font-medium text-[#0F172A]">PowerWash Liquid</td>
                  <td className="p-6">25L / 50L / Bulk</td>
                  <td className="p-6">Auto-Dosing Systems</td>
                  <td className="p-6">Enzyme Active Formula</td>
                </tr>
                <tr className="hover:bg-[#0B3C5D]/5 transition-colors">
                  <td className="p-6 font-medium text-[#0F172A]">SoftBreeze Fabric</td>
                  <td className="p-6">25L / 50L</td>
                  <td className="p-6">Finishing & Softening</td>
                  <td className="p-6">Anti-Static Treatment</td>
                </tr>
              </tbody>
            </table>
          </div>
